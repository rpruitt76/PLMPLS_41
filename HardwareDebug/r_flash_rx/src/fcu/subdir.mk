...
C_SRCS += \
../r_flash_rx/src/fcu/r_flash_fcu_64m_rx.c \
../r_flash_rx/src/fcu/r_flash_fcu_rx.c 

COMPILER_OBJS += \
r_flash_rx/src/fcu/r_flash_fcu_64m_rx.obj \
r_flash_rx/src/fcu/r_flash_fcu_rx.obj 

C_DEPS += \
r_flash_rx/src/fcu/r_flash_fcu_64m_rx.d \
r_flash_rx/src/fcu/r_flash_fcu_rx.d 

# Each subdirectory must supply rules for building sources it contributes
r_flash_rx/src/fcu/%.obj: ../r_flash_rx/src/fcu/%.c r_flash_rx/src/fcu/Compiler.sub
	...
	@echo r_flash_rx\src\fcu\cSubCommand.tmp=
	@sed -e "s/^/ /" "r_flash_rx\src\fcu\cSubCommand.tmp"
	ccrx -subcommand="r_flash_rx\src\fcu\cSubCommand.tmp" "$<"
