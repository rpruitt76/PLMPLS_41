...
r_flash_rx/src/%.obj: ../r_flash_rx/src/%.c r_flash_rx/src/Compiler.sub
	...
	@echo r_flash_rx\src\cSubCommand.tmp=
	@sed -e "s/^/ /" "r_flash_rx\src\cSubCommand.tmp"
	ccrx -subcommand="r_flash_rx\src\cSubCommand.tmp" "$<"
