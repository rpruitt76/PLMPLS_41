...
#define _19_MTU5_IOC_T                  (0x19U) /* Capture at trough in complementary PWM mode */
#define _1A_MTU5_IOC_C                  (0x1AU) /* Capture at crest of complementary PWM mode */
#define _1B_MTU5_IOC_CT                 (0x1BU) /* Capture at crest and trough of complementary PWM mode */
...
#define _00_MTU_CST2_OFF                (0x00U) /* MTU3.TCNT performs count stop */
#define _04_MTU_CST2_ON                 (0x04U) /* MTU3.TCNT performs count operation */
...
#define _02_MTU_CSTU5_ON                (0x02U) /* MTU5.TCNTU performs count operation */
...
#define _00_MTU_SYNC2_OFF               (0x00U) /* MTU3.TCNT operates independently */
#define _04_MTU_SYNC2_ON                (0x04U) /* MTU3.TCNT performs synchronous operation */
...
#define _00_MTU_FB_EXIN                 (0x00U) /* Output is switched by external input */
#define _08_MTU_FB_SW                   (0x08U) /* Output is switched by software */
/* Positive-Phase Output Control (P) */
#define _00_MTU_P_LEVEL                 (0x00U) /* Level output */
#define _10_MTU_P_PWM                   (0x10U) /* Reset-synchronized PWM or complementary PWM output */
/* Negative-Phase Output Control (N) */
#define _00_MTU_N_LEVEL                 (0x00U) /* Level output */
#define _20_MTU_N_PWM                   (0x20U) /* Reset-synchronized PWM or complementary PWM output */
/* Brushless DC Motor (BDC) */
#define _00_MTU_BDC_OUT                 (0x00U) /* Ordinary output */
#define _40_MTU_BDC_FUN                 (0x40U) /* Functions of this register are made effective */
...
#define _00_MTU_TF_NO_INT               (0x00U) /* Enables transfer, does not link with interrupt skipping operation */
#define _01_MTU_TF_DISABLE              (0x01U) /* Disables transfer from buffer registers to the temporary registers */
...
#define _00_MTU_TGIE5V_DISABLE          (0x00U) /* Interrupt requests TCI5V disabled */
#define _02_MTU_TGIE5V_ENABLE           (0x02U) /* Interrupt requests TCI5V enabled */
/* TGR Interrupt Enable 5U (TGIE5U) */
#define _00_MTU_TGIE5U_DISABLE          (0x00U) /* Interrupt requests TCI5U disabled */
#define _04_MTU_TGIE5U_ENABLE           (0x04U) /* Interrupt requests TCI5U enabled */
...
***********************************************************************************************************************/
/* TGRB value */
#define _0B72_TCNTB_VALUE               (0x0B72U)
/* TGRC value */
#define _0003_TCNTC_VALUE               (0x0003U)
/* TGRE value */
#define _0003_TCNTE_VALUE               (0x0003U)
/* TGRF value */
#define _0003_TCNTF_VALUE               (0x0003U)
/* TGRA value */
#define _0B72_TCNTA_VALUE               (0x0B72U)
/* TGRB value */
#define _0003_TCNTB_VALUE               (0x0003U)
/* TGRA value */
#define _0002_TCNTA_VALUE               (0x0002U)
/* TGRE value */
#define _0BB8_TCNTE_VALUE               (0x0BB8U)
/* TGRB value */
#define _0B72_TCNTB_VALUE               (0x0B72U)
/* TGRE value */
#define _0003_TCNTE_VALUE               (0x0003U)
...
#define _0003_TCNTF_VALUE               (0x0003U)
/* TGRD value */
#define _0003_TCNTD_VALUE               (0x0003U)
/* TGRE value */
#define _0BB8_TCNTE_VALUE               (0x0BB8U)
/* TGRB value */
#define _0B72_TCNTB_VALUE               (0x0B72U)
