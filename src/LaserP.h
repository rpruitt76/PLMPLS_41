...
#define	 VERSIONNUM		"5.01" 		 // Current Version Revision.(4 CHARS)
#define  RELDATE		"10/30/23"	 // Current Release Date.(8 Chars)
#define	 VERSIONSTR		"PLM PLUS V5.01 OCt 30, 2023" 		 // Current Version String Revision.
