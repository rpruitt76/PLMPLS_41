...
#define	 VERSIONNUM		"4.03" 		 // Current Version Revision.(4 CHARS)
#define  RELDATE		"01/20/22"	 // Current Release Date.(8 Chars)
#define	 VERSIONSTR		"PLM PLUS V4.03 Jan 20, 2022" 		 // Current Version String Revision.
