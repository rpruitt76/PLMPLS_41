...
#define	 VERSIONNUM		"4.01" 		 // Current Version Revision.(4 CHARS)
#define  RELDATE		"06/04/21"	 // Current Release Date.(8 Chars)
#define	 VERSIONSTR		"PLM PLUS V4.1 Jun 4, 2021" 		 // Current Version String Revision.
