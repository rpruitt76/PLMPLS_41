...
#define	 VERSIONNUM		"4.05" 		 // Current Version Revision.(4 CHARS)
#define  RELDATE		"03/12/22"	 // Current Release Date.(8 Chars)
#define	 VERSIONSTR		"PLM PLUS V4.05 Mar 12, 2022" 		 // Current Version String Revision.
