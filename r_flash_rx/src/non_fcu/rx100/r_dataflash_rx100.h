...
#ifndef R_DATAFLASH_RX100_H_
#define R_DATAFLASH_RX100_H_
...
void R_DF_Erase_Operation (const uint32_t block_start_addr, const uint32_t block_end_addr);
