...
flash_err_t R_FLASH_Open(void)
{
    ...
    // The Flash control circuit cannot program or erase ROM while executing or reading from ROM
...
/******************************************************************************
End of function  flash_lock_state
******************************************************************************/
...
// RX100 has it's own
#if !defined(BSP_MCU_SERIES_RX100)
/***********************************************************************************************************
