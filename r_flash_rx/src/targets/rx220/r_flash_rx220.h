...
#if   BSP_CFG_MCU_PART_MEMORY_SIZE == 0x1   //   32KB ROM
...
#if   BSP_CFG_MCU_PART_MEMORY_SIZE == 0x3   //   64KB ROM
    FLASH_CF_BLOCK_INVALID = 0x00FEFFFF,
#else
...
#if   BSP_CFG_MCU_PART_MEMORY_SIZE == 0x5   //   128KB ROM
...
#if   BSP_CFG_MCU_PART_MEMORY_SIZE == 0x6   //   256KB ROM
