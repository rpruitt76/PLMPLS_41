...
#ifndef _FLASH_API_RX111_H
#define _FLASH_API_RX111_H
...
typedef enum _flash_block_address
{
...
#if   BSP_CFG_MCU_PART_MEMORY_SIZE == 0x5   //   '5' parts 128KB ROM
...
#if   BSP_CFG_MCU_PART_MEMORY_SIZE == 0x6   //   '6' parts 256KB ROM
    FLASH_CF_BLOCK_INVALID = 0xFFFBFC00,
#else
...
#if   BSP_CFG_MCU_PART_MEMORY_SIZE == 0x7   //   '7' parts 384KB ROM
    FLASH_CF_BLOCK_INVALID = 0xFFF9FC00,
#else
    ...
    FLASH_CF_BLOCK_INVALID = 0xFFF7FC00,
#endif
#endif
#endif
#endif
