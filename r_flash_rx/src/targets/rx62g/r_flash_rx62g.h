...
#if   BSP_CFG_MCU_PART_MEMORY_SIZE == 0x6   //   64KB ROM
...
#if   BSP_CFG_MCU_PART_MEMORY_SIZE == 0x7   //   128KB ROM
...
#if   BSP_CFG_MCU_PART_MEMORY_SIZE == 0xa   //   256KB ROM
...
#if   BSP_CFG_MCU_PART_MEMORY_SIZE == 0x7    //   8KB Data Flash
