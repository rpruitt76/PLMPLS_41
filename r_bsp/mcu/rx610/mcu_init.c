 ...
 */
    ...
    #define BSP_PRV_PORTF_NE_PIN_MASK     (0x7F)    /* Missing pins: PF0 PF1 PF2 PF3 PF4 PF5 PF6 */
    #define BSP_PRV_PORTG_NE_PIN_MASK     (0xFF)    /* Missing pins: PG0 PG1 PG2 PG3 PG4 PG5 PG6 PG7 */
    #define BSP_PRV_PORTH_NE_PIN_MASK     (0xFF)    /* Missing pins: PH0 PH1 PH2 PH3 PH4 PH5 PH6 PH7 */
#else
...
void bsp_non_existent_port_init (void)
{
    ...
    PORTH.DDR.BYTE |= BSP_PRV_PORTG_NE_PIN_MASK;
#endif
}
