...
typedef enum
{
    /* Enables writing to the registers related to the clock generation circuit: SCKCR, SCKCR3, PLLCR, PLLCR2,
       MOSCCR, SOSCCR, LOCOCR, ILOCOCR, HOCOCR, OSTDCR, OSTDSR, HOCOCR2. */
    ...
    /* Enables writing to the registers related to operating modes, low power consumption, the clock generation circuit,
       and software reset: SYSCR1, SBYCR, MSTPCRA, MSTPCRB, MSTPCRC, MSTPCRD, OPCCR, RSTCKCR, MOSCWTCR, SOSCWTCR,
       PLLWTCR, DPSBYCR, DPSIER0, DPSIER2, DPSIFR0, DPSIFR2, DPSIEGR0, DPSIEGR2, FHSSBYCR, HOCOWTCR2, MOFCR, HOCOPCR,
       PLLPCR, SWRR. */
