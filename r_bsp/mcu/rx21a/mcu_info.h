...
/* This macro means that this MCU is part of the RX21x collection of MCUs (i.e. RX210, RX21A). */
#define BSP_MCU_RX21_ALL            (1)

/* MCU Group name. */
#if   BSP_CFG_MCU_PART_GROUP == 0x1
    #define BSP_MCU_RX21A           (1)
#else
...
#define BSP_PCLKA_HZ                (BSP_SELECTED_CLOCK_HZ / BSP_CFG_PCKA_DIV)  /* Peripheral Module Clock A speed in Hz. */
#define BSP_PCLKB_HZ                (BSP_SELECTED_CLOCK_HZ / BSP_CFG_PCKB_DIV)  /* Peripheral Module Clock B speed in Hz. */
#define BSP_PCLKC_HZ                (BSP_SELECTED_CLOCK_HZ / BSP_CFG_PCKC_DIV)  /* Peripheral Module Clock C speed in Hz. */
