...
* Device(s)    : RX113
* Description  : Information about the MCU on this board (RSKRX113).
***********************************************************************************************************************/
/***********************************************************************************************************************
...
/* Memory size of your MCU. */
    ...
    #define BSP_RAM_SIZE_BYTES              (32768)     // different from RX111
...
*/ 
    ...
    #define BSP_UCLK_HZ             (BSP_ICLK_HZ)                               /* USB clock speed in Hz. */
...
#define BSP_SSISCK_HZ               (BSP_CFG_XTAL_HZ)                           /* SSI clock speed in Hz */

#if   (BSP_CFG_LCD_CLOCK_SOURCE == 0)                                           
    #define BSP_LCDSRCCLK_HZ        (BSP_LOCO_HZ)                               /* LCD clock speed in Hz */
...
/* If r_cgc_rx11x is being used then modules using these macros will need to have the interface file. */
#include "r_cgc_rx100_if.h"
