 ...
 */
    ...
    #define BSP_PRV_PORTH_NE_PIN_MASK     (0x30)    /* Missing pins: PH4 PH5 */
    #define BSP_PRV_PORTJ_NE_PIN_MASK     (0x00)    /* Missing pins: None */
    #define BSP_PRV_PORTK_NE_PIN_MASK     (0xC3)    /* Missing pins: PK0 PK1 PK6 PK7 */
    #define BSP_PRV_PORTL_NE_PIN_MASK     (0x1C)    /* Missing pins: PL2 PL3 PL4 */
    ...
    #define BSP_PRV_PORTK_NE_PIN_MASK     (0xFF)    /* Missing pins: PK0 PK1 PK2 PK3 PK4 PK5 PK6 PK7 */
    #define BSP_PRV_PORTL_NE_PIN_MASK     (0x1F)    /* Missing pins: PL0 PL1 PL2 PL3 PL4 */
