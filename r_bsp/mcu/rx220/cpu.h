...
typedef enum
{
    /* Enables writing to the registers related to the clock generation circuit: SCKCR, SCKCR3, MOSCCR, SOSCCR, LOCOCR,
       ILOCOCR, HOCOCR, OSTDCR, OSTDSR, HOCOCR2. */
    ...
    /* Enables writing to the registers related to operating modes, low power consumption, the clock generation circuit,
       and software reset: SYSCR1, SBYCR, MSTPCRA, MSTPCRB, MSTPCRC, OPCCR,RSTCKCR, MOSCWTCR, SOSCWTCR, FHSSBYCR,
       HOCOWTCR2, MOFCR, HOCOPCR, SWRR. */
