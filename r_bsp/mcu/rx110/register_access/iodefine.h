...
/* History    : V1.0A (2014-02-26)  [Hardware Manual Revision : 1.00]           */
...
#define	FLASH	(*(volatile struct st_flash  __evenaccess *)0x7FC0B0)
...
#define	MTU		(*(volatile struct st_mtu    __evenaccess *)0x88680)
