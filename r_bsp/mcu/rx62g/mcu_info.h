...
*         : 19.11.2012 1.10     Added null argument macros. Updated code to use 'BSP_' and 'BSP_CFG_' prefix for macros.
...
*         : 21.06.2013 1.40     Fixed FIT_NO_FUNC & FIT_NO_PTR to be 0x10000000 instead of 0xA0000000 since it causes
