...
*         : 30.05.2014 1.11    Added settings for the OFS registers.
*
***********************************************************************************************************************/
 ...
 */
#define BSP_CFG_USER_WARM_START_CALLBACK_PRE_INITC_ENABLED    (1)
#define BSP_CFG_USER_WARM_START_PRE_C_FUNCTION     my_sw_warmstart_beep
