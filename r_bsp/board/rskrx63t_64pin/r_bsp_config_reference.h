...
*                              Vcc.
*         : 25.06.2013 1.50    Added BSP_CFG_USER_STACK_ENABLE macro to enable/disable use of user stack. Removed 
...
/* Enter the product part number for your MCU. This information will be used to obtain information about your MCU such 
   ...
   | | | |  |  | |______BSP_CFG_MCU_PART_CAN_INCLUDED = 3V/5V, CAN included/not included
...
/* Package type. Set the macro definition based on values below:
   ...
   FL           = 0x9             = LQFP/48/0.50
*/
#define BSP_CFG_MCU_PART_PACKAGE        (0x8)

/* Whether CAN is included or not. 
   Character(s) = Value for macro = Description
   E            =                 = 3V, no can (RX63T does not offer CAN)
*/
#define BSP_CFG_MCU_PART_CAN_INCLUDED   (false)
...
/* Clock configuration options.
   ...
   ICLK is 96MHz, PCLKA is 48MHz, PCLKB is 48MHz, PCLKD is 48MHz, and FCLK is 48MHz then the settings would be:

   BSP_CFG_XTAL_HZ = 16000000
   BSP_CFG_PLL_DIV = 1  (no division)
   BSP_CFG_PLL_MUL = 12 (16MHz x 12 = 192MHz)
