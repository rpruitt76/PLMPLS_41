...
*         : 27.06.2012 1.15    Added MCU product part number section. Added option for ROM Code Protect. Added callback 
...
/* Enter the product part number for your MCU. This information will be used to obtain information about your MCU such 
   ...
   R 5 F 56 10 8 V N FP
   | | | |  |  | | | |  Macro Name              Description
   | | | |  |  | | | |__BSP_CFG_MCU_PART_PACKAGE      = Package type
   | | | |  |  | | |____not used                      = Characteristic code (N: Regular spec, D: Wide-range spec)
   | | | |  |  | |______not used                      = Number of pins (package tells us this)
...
*/
#define BSP_CFG_MCU_PART_MEMORY_SIZE    (0x7)
...
/* Clock configuration options.
   ...
   multiplier settings are used to set the clock registers in resetprg.c. If a 12.5MHz clock is used and the 
