...
*                               and the ability to enable NMI interrupts based on the BSP_CFG_NMI_ISR_CALLBACK. 
...
static void operating_frequency_set (void)
{
    ...
    ----------------------------------------
    Input Clock Frequency..............12.5MHz
    Internal Clock Frequency...........100MHz
    Peripheral Clock Frequency.........50MHz */
    
    /* SCKCR - System Clock Control Register 
    b27:b23 ICK[3:0] = 0, system clock = EXTAL * 8 = 100 MHz
    b11:b8  PCK[3:0] = 1, PCK = EXTAL * 4 = 50 MHz
    */
