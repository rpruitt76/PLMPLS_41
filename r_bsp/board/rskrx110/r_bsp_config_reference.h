...
*/ 
#define BSP_CFG_CLOCK_SOURCE            (2)

/* Clock configuration options.
   The input clock frequency is specified and then the system clocks are set by specifying the dividers used. The
   divider settings are used to set the clock registers in resetprg.c. If a 16MHz clock is used and the
   ICLK is 8MHz, PCLKB is 8MHz, FCLK is 8MHz, PCLKD is 8MHz, and CKO is 1MHz then the
   settings would be:

   BSP_CFG_XTAL_HZ = 16000000
   BSP_CFG_ICK_DIV =  2      : System Clock (ICLK)        = 
                               (BSP_CFG_XTAL_HZ / BSP_CFG_ICK_DIV)  = 8MHz
   BSP_CFG_PCKB_DIV = 2      : Peripheral Clock B (PCLKB) = 
                               (BSP_CFG_XTAL_HZ / BSP_CFG_PCKB_DIV) = 8MHz
   BSP_CFG_PCKD_DIV = 2      : Peripheral Clock D (PCLKD) = 
                               (BSP_CFG_XTAL_HZ / BSP_CFG_PCKD_DIV) = 8MHz
   BSP_CFG_FCK_DIV =  2      : Flash IF Clock (FCLK)      = 
                               (BSP_CFG_XTAL_HZ / BSP_CFG_FCK_DIV)  = 8MHz
*/
